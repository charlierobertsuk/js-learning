...
console.log(
  `${selectedPerson} is number ${
    friends.indexOf(selectedPerson) + 1
  } on the list`
);
...
console.log(
  `${popped} has been removed from the list, now it is currently: ${friends}`
);
const shifting = friends.shift();
console.log(
  `${shifting} has been removed from the list, now it is currently: ${friends}`
);
