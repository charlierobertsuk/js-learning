...
const charlie = {
    ...
    calcAge1: function(birthYear) { // A function attached to an object is a method
    ...
    getSummery: function() {
        return `${charlie.firstName} is a ${charlie.age}-year old ${charlie.occupation}, and he has ${this.hasDriversLicence ? `a` : `no`} drivers licence`;
    }
};
